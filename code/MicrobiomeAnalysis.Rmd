...
These graphs suggest that a log(1+x) transformations might be sufficient for ```normalizing``` the abundance data for exploratory analysis. 
We look at the principal coordinates analysis (PCoA) with the Bray-Curtis dissimilarity on the weighted Unifrac distance. H
...
This is rank thershold transformation. 
